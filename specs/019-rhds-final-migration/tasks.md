...
- [x] B1 checkpoint passed (behavior + a11y/visual + rollback readiness)
- [x] B2 checkpoint passed (behavior + a11y/visual + rollback readiness)
- [x] B3 checkpoint passed or explicitly deferred with accepted rationale
- [x] Mapping documents updated for all families in `specs/019-rhds-final-migration/validation/step1-hybrid-component-map.md`
- [x] Contract mapping updated in `specs/019-rhds-final-migration/contracts/rhds-pf-retirement-contract.v1.json`
- [x] Regression matrix complete with evidence in `tests/mcp-app/regression/step1-hybrid/final-matrix-results.md`
- [x] Build/serve parity confirmed in `tests/mcp-app/regression/step1-hybrid/build-serve-sanity.md`

## Explicit Prerequisites to Begin Step 2

- [x] All Step 1 batch checkpoints (B1/B2/B3) are resolved as pass or formally deferred
- [x] No unresolved critical regressions in behavior, security boundaries, accessibility, or visual flows
- [x] Step 1 mapping and retirement logs are current and approved
- [x] Rollback instructions have been rehearsed and documented for each completed batch
- [x] Stakeholder signoff confirms readiness for Step 2 final migration cutover
